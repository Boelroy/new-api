...
import { api, ROLE_ADMIN, ROLE_PROJECT_ADMIN, ROLE_REMOTE_STUDIO_OPERATOR, ROLE_STUDIO_OPERATOR, ROLE_SUPER_ADMIN, ROLE_SUPPLIER_01, ROLE_SUPPLIER_02, ROLE_TESTER, ROLE_USER, type AuthMe, type AuthUser } from '../api'
...
const ROLE_OPTIONS: { value: number; label: string }[] = [
  ...
  { value: ROLE_SUPPLIER_02, label: 'Supplier 02 (KHub key upload + usage only)' },
